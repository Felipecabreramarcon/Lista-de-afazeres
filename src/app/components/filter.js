const Filter = ({ filter, setFilter, setSort }) => {
    return (
        <div className="filter w-11/12 flex flex-col gap-2  border-b-[2px] border-black pb-4   ">
            <h2 className="m-0 p-0 desktop:text-2xl mobile:text-base">Filtrar:</h2>
            <div className="flex flex-row justify-between items-center gap-8 ">
                <div className="filter-options flex flex-col gap-2 flex-1">
                    <p className="mobile:text-sm">Status:</p>
                ...
                <div className="flex flex-col gap-2 flex-1">
                    <p className="mobile:text-xs  whitespace-nowrap">Ordem alfabética:</p>
